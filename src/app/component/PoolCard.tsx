...
const PoolCard: React.FC<PoolCardProps> = ({ pool }) => {
  const openWhatsApp = () => {
    ...
    const message = `Hi ${pool.name}, I'm interested in sharing cab with you from ${pool.startLocation} to ${pool.endLocation} on ${pool.date}. Could we discuss the details?`;
  ...
  return (
    <div className="border border-gray-200 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 bg-white relative overflow-hidden transform hover:-translate-y-1 h-full flex flex-col">
      ...
      {/* Card Content (flex-grow will push the button to the bottom) */}
